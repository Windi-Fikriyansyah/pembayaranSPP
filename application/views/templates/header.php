...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php if ($this->fungsi->user_login()->hak_akses == 'Admin') { ?>
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?= base_url('data_siswa'); ?>">Data Siswa</a>
                            <a class="collapse-item" href="<?= base_url('data_kelas'); ?>">Data Kelas</a>
                            <a class="collapse-item" href="<?= base_url('data_angkatan'); ?>">Data Angkatan</a>
                            <a class="collapse-item" href="<?= base_url('data_petugas'); ?>">Data Pengguna</a>
                        </div>
                    </div>
                </li>
                ...
                <!-- Heading -->
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('pembayaran_spp'); ?>">
                        <i class="fas fa-fw fa-edit"></i>
                        <span>Pembayaran SPP</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('pembayaran_spp/data_pembayaran'); ?>">
                        <i class="fas fa-fw fa-table"></i>
                        <span>Data Pembayaran</span></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('laporan_admin/index'); ?>">
            ...
            <?php } ?>
             ...
             <?php if ($this->fungsi->user_login()->hak_akses == 'Kepala sekolah') { ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('laporan_admin/index'); ?>">
                        <i class="fas fa-fw fa-chart-area"></i>
                        <span>Laporan Keuangan</span></a>
            ...
            <?php if ($this->fungsi->user_login()->hak_akses == 'Siswa') { ?>
                <!-- Nav Item - Charts -->
                <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="<?= base_url('data_siswa/index'); ?>" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $this->fungsi->user_login()->nama_petugas ?></span>
